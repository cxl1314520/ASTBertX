...
class Config:
    ...
    BASE_PATH = "/home/xlc/BERTAST/"
    DATA_PATH = os.path.join(BASE_PATH, "bert/graphcodebert_mean.jsonl")
    AST_GRAPH_DIR = os.path.join(BASE_PATH, "ast")
    SCRIPT_FOLDER = os.path.join(BASE_PATH, "data")
    PRETRAINED_MODEL = os.path.join(BASE_PATH, "LocalModel/code_bert")

    BERT_MODEL_PATH = os.path.join(BASE_PATH, "output/graphcodebert_best.pt")
    AST_MODEL_PATH = os.path.join(BASE_PATH, "output/ast_only_model.pt")
    FUSION_MODEL_PATH = os.path.join(BASE_PATH, "output/fusion_model.pt")
